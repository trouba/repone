	...
	for (var abNumber = 0; abNumber < doc.artboards.length; abNumber++) {
		if (artboardsToProcess[abNumber]) {
			...
			if (docSettings.output=="multiple-files") {
				...
				var headerText          = "<html>\r"
				headerText             += "<head>\r";
				headerText             += "<meta http-equiv='content-type' content='text/html; charset=utf-8' />\r";
				headerText             += "</head>\r";
				headerText             += "<body>\r";
				headerText             += "<div id='" + nameSpace + docArtboardName + "-box' class='ai2html'>\r";
				headerText             += "\t<!-- Generated by ai2proto v" + scriptVersion + " - " + dateTimeStamp + " -->\r";
